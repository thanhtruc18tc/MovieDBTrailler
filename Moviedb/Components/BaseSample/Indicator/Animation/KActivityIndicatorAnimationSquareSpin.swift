//
//  KActivityIndicatorAnimationSquareSpin.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationSquareSpin: KActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw square
        let square = KActivityIndicatorShape.rectangle.layerWith(size: size, color: color)
