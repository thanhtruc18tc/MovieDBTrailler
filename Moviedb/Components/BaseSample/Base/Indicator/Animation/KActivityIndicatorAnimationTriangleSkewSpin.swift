//
//  KActivityIndicatorAnimationTriangleSkewSpin.swift
//  DemoLoading
//
...
class KActivityIndicatorAnimationTriangleSkewSpin: KActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw triangle
        let triangle = KActivityIndicatorShape.triangle.layerWith(size: size, color: color)
